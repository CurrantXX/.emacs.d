...
(defvar window-numbering-keymap
  (let ((map (make-sparse-keymap)))
    (define-key map (kbd "C-0") 'select-window-0)
    (define-key map (kbd "C-1") 'select-window-1)
    (define-key map (kbd "C-2") 'select-window-2)
    (define-key map (kbd "C-3") 'select-window-3)
    (define-key map (kbd "C-4") 'select-window-4)
    (define-key map (kbd "C-5") 'select-window-5)
    (define-key map (kbd "C-6") 'select-window-6)
    (define-key map (kbd "C-7") 'select-window-7)
    (define-key map (kbd "C-8") 'select-window-8)
    (define-key map (kbd "C-9") 'select-window-9)
